...
if [[ -d ./bowtie ]]; then
    ...
    wget https://sourceforge.net/projects/bowtie-bio/files/bowtie/1.1.2/bowtie-1.1.2-linux-x86_64.zip && unzip bowtie-1.1.2-linux-x86_64.zip
    rm -rf bowtie-1.1.2-linux-x86_64.zip
